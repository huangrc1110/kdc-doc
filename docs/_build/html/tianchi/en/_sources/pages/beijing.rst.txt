...
.. note::
   ...
   1. 线下赛通过 `天池平台 <https://tianchi.aliyun.com/competition/entrance/532415>`_ 统一提交，每个任务最多 5 次有效提交。
   2. 线下赛期间，官方预计提供有限 GPU 资源，待后续官方通知。参赛队伍需优先使用自有 GPU 服务器完成模型训练、调试和镜像准备。
...
请下载并阅读 `天池现场赛指导手册 <../_static/docs/天池现场赛指导手册.pdf>`_ 。
